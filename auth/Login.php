    ...
    if (mysqli_num_rows($result) === 1) {
        ...
        if (password_verify($password, $row["password"])) {
            if ($row['status'] == 'Aktif') {
                ...
                if ($row['role'] === 'admin') {
                    header("Location: " . base_url('admin/home/home.php'));
                    exit();
                } else {
                    header("Location: " . base_url('pegawai/home/home.php'));
                    exit();
                }
            } else {
                $_SESSION['Gagal'] = "Gagal Login! Akun Anda Tidak Aktif!";
            }
        } else {
            $_SESSION['Gagal'] = "Gagal Login! Password Salah!";
        }

    } else {
        $_SESSION['Gagal'] = "Gagal Login! Username atau Password Salah!";
    }
