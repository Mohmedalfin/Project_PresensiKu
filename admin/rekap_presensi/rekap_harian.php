...
if (empty($_GET['tanggal_dari'])) {
    $result = mysqli_query($connection, "SELECT presensi.*, pegawai.name , pegawai.lokasi_presensi FROM presensi JOIN pegawai ON presensi.id_pegawai = pegawai.id WHERE tanggal_masuk  ORDER BY tanggal_masuk DESC");
} else {
