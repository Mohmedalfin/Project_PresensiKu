...
if (isset($_POST['submit'])) {
    ...
    if (empty($pesan_kesalahan)) {
        $user = "INSERT INTO ketidakhadiran
        (id_pegawai, keterangan, deskripsi, tanggal, status_pengajuan, file) 
        VALUES 
        ...
        if ($result1) {
            $_SESSION['berhasil'] = 'Data pengajuan berhasil ditambahkan';
        } else {
        ...
        echo "<script>window.location.href='pengajuan_ketidakhadiran.php';</script>";
        exit();
    }
}
